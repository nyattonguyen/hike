...
export default function Add() {
  ...
  const [selectedIndex, setIndex] = useState(0); // 0 = yes, 1 = no
  const [lenghtHight, setLenghtHight] = useState(0);
    ...
    db.transaction((tx) => {
      "SELECT COUNT(*) FROM hikes",
        ...
        tx.executeSql(
          ...
          [name, location, dateHike, selectedIndex, lenghtHight, level, desc],
          (txObj, resultSet) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.title}>
        <Text style={styles.h1}>Add new hike</Text>
      </View>
      <ScrollView>
          ...
          {visible === true ? (
            <Dialog isVisible={visible} onBackdropPress={toggleDialog}>
              ...
              >
                ...
                <Text>Length of the hike: {data.lenghtHight}</Text>
                <Text>Difficulty level: {data.level}</Text>
